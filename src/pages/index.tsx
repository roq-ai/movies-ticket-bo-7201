  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Movies Ticket Booking Online: Your One-Stop Destination for Showtimes, Movie Tickets, Reviews, Trailers, Concert Tickets, and Events. Experience the Magic of Cinema Right at Your Fingertips"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616530940355-351fabd9524b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb3ZpZXN8ZW58MHx8fHwxNjk4NjY5NjA5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Movies Ticket Booking Online: Your One-Stop Destination for Showtimes, Movie Tickets, Reviews, Trailers, Concert Tickets, and Events. Experience the Magic of Cinema Right at Your Fingertips`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Event Manager" type="event-manager" abilities={appConfig.ownerAbilities} />
